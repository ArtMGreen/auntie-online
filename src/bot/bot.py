...
class BotHandlers:
    def __init__(self, yandex_bot, vector_store):
    ...
    async def reset_history(self, update: Update, _context: ContextTypes.DEFAULT_TYPE):
        ...
        self.yandex_bot.reset_user_history(user_id)
        await update.message.reply_text(
    ...
    async def show_history_info(
        ...
        user_id = update.effective_user.id
        history = self.yandex_bot.get_user_history(user_id)
    ...
    async def handle_message(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        try:
            ...
            response = self.yandex_bot.ask_gpt(user_message, user_id)
            await update.message.reply_text(response)
